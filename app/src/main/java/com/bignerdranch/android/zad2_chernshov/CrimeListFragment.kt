...
class CrimeListFragment : Fragment() {
    ...
    private open class CrimeHolder(view: View):RecyclerView.ViewHolder(view), View.OnClickListener {
        private lateinit var crime: Crime
        ...
        override fun onClick(view: View) {
            Toast.makeText(null,"${crime.title} pressed!", Toast.LENGTH_SHORT).show()
        }

    }


    private open class CrimeAdapter(var crimes: List<Crime>)
